    ...
    <div class="row">
       <div class="col-md-12">
                 ...
                 <select name="id_kategori" class="form-control">
                     <?php
                         ...
                         while($kategori = mysqli_fetch_array($kat)) {
                            ?>
                            <option <?php if($kategori['id_kategori'] == $data['id_kategori']) echo 'selected'; ?> value="<?php echo $kategori['kategori'];?>"></option>
                            <?php
                         }
                     ?>
                </select>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8"><input type="number" value="<?php echo $data['tahun_penerbit']; ?>" class="form-control" name="tahun_terbit"></div>
        </div>
        <div class="row mb-3">
